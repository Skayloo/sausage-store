...
sudo rm -r /opt/sausage-store/static/sausage-store/frontend
curl -u ${NEXUS_REPO_USER}:${NEXUS_REPO_PASS} -o sausage-store.tar.gz ${NEXUS_REPO_URL_FRONTEND}std-022-039-frontend/std-022-039-frontend/std-022-039-frontend/${VERSION}/sausage-store-${VERSION}.tar.gz
